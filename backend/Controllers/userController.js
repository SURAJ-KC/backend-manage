...
const regiterUser = asyncHandler(async(req,res) => {
    ...
    if(userAvailable){
        res.status(400);
        throw new Error("User Already Regitered!");
    }
    //Hash password 
    ...
    console.log(`User created ${user} succesfully `);
    if(user){
        ...
        res.status(400);
        throw new Error("User data is not valild");
    }
...
module.exports = {regiterUser,loginUser, currentUser};